...
class WarpControlPointsBaseOf: public SourceMemoryOf<PointOf<DIMENSIONALITY,
    Real> , DIMENSIONALITY>
{
public:
};
...
//============================================================================
template<int DIMENSIONALITY>
class WarpControlPointsOf: public WarpControlPointsBaseOf<DIMENSIONALITY>
{
};
...
//============================================================================
template<>
class WarpControlPointsOf<2> : public WarpControlPointsBaseOf<2>
{
...
//============================================================================
template<>
class WarpControlPointsOf<3> : public WarpControlPointsBaseOf<3>
{
...
typedef SourceAccessorCubicInterpolateOf<Point2DReal, 2, int,
    WarpControlPoints2D> WarpfieldCubicSpline2D;
typedef SourceAccessorCubicInterpolateOf<Point2DReal, 3, int,
    WarpControlPoints3D> WarpfieldCubicSpline3D;

typedef SourceAccessorCubicInterpolateOf<Point2DReal, 2, Real,
    WarpControlPoints2D> WarpfieldCubicSpline2DReal;
typedef SourceAccessorCubicInterpolateOf<Point2DReal, 3, Real,
    WarpControlPoints3D> WarpfieldCubicSpline3DReal;

//============================================================================
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceTransformWarpBaseOf: public SourceTransformOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
protected:
  typedef PointOf<DIMENSIONALITY, Real> WARPPOINT;
  typedef WarpControlPointsOf<DIMENSIONALITY> WARPCONTROLPOINTS;
  typedef SourceAccessorCubicInterpolateOf<WARPPOINT, DIMENSIONALITY, Real,
      WARPCONTROLPOINTS> WARPINTERPOLATEDCONTROLPOINTS;
  typedef SourceTransformScaleOf<WARPPOINT, DIMENSIONALITY, PRECISION,
...
public:
  ...
  void AllocateWarpfield(PointOf<DIMENSIONALITY, int> ptSizeWarp, InterpolationType it =
      Cubic)
  {
    ReleasePointer(m_pwarpfield);

    WarpControlPointsOf<DIMENSIONALITY> *pcp = new WarpControlPointsOf<
        DIMENSIONALITY> ;
  ...
  virtual String Describe() const
  {
    return (_LINE + "SourceTransformWarp" + LINE_ + (_INDENT + "with field: "
        + LINE_) + (_INDENT2 + m_pwarpfield->Describe())
        + this->DescribeCommon());
  }
  ...
  void PrepareForAccessAction() const
  {
    ...
    m_pwarpfield->SetScale(PointOf<DIMENSIONALITY, Real> (
        this->PSource()->Size()) / m_pwarpfield->PSource()->Size());
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceTransformWarpOf: public SourceTransformWarpBaseOf<DATA,
...
class SourceTransformWarpOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformWarpBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformWarpOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformWarpBaseOf<
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
void IncreaseWarpfieldControlPointResolution(SourceTransformWarpOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE> &srcWarp, const PointOf<DIMENSIONALITY,
    Real> &ptSize, int nInterpType = 3)
{
  D("increasing resolution of warpfield control points");
  srcWarp.PrepareForAccess();
  srcWarp.SetWarpControlPoints(RasterizeInto(HandoffPointer(
      new typename SourceTransformWarpOf<DATA, DIMENSIONALITY, PRECISION,
          SOURCE>::WarpControlPoints), ScaleTo(ptSize,
      srcWarp.GetPInterpolatedWarpControlPoints())));
  srcWarp.SetWarpfieldInterpolation(InterpolationType(nInterpType));
}
