...
class SourceMemoryBaseOf: public SourceOf<DATA, DIMENSIONALITY, int>
{
...
public:
  ...
  //--------------------------------------------------------------------------
  SourceMemoryBaseOf() :
    SourceOf<DATA, DIMENSIONALITY, int> (), m_ptSize(0), m_vdata(NULL)
  {
  }
  ...
  {
    return (_LINE + "SourceMemory(" + DIMENSIONALITY + "D)" + LINE_
        + this->DescribeCommon());
  }
  ...
  {
    return pt.Bound(PointOf<DIMENSIONALITY, int> (0), m_ptSize - 1);
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY>
class SourceMemoryOf: public SourceMemoryBaseOf<DATA, DIMENSIONALITY>
{
...
SOURCE* Allocate(const PointOf<DIMENSIONALITY, int>& ptSize, SOURCE* psm)
{
  psm->Allocate(ptSize);
  return psm;
}
...
SOURCE* Fill(const DATA& data, SOURCE *psm)
{
  psm->Fill(data);
  return psm;
}
