...
class SourceAccessorLinearInterpolateOf: public SourceAccessorOf<DATA,
...
class SourceAccessorLinearInterpolateOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorOf<
    DATA, 2, PRECISION, SOURCE>
{
public:
  virtual String Describe() const
  {
    return (_LINE + "SourceAccessorLinearInterpolateOf(2D)" + LINE_
        + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorLinearInterpolateOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorOf<
    DATA, 3, PRECISION, SOURCE>
{
public:
  virtual String Describe() const
  {
    return (_LINE + "SourceAccessorLinearInterpolateOf(3D)" + LINE_
        + this->DescribeCommon());
  }
