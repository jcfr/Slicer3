...
inline SourceAccessorOf<DATA, DIMENSIONALITY, Real, SourceOf<DATA,
    DIMENSIONALITY, int> >*
NewInterpolatedSource(SourceOf<DATA, DIMENSIONALITY, int>* psrc, InterpolationType it =
    Cubic)
{
  ...
  switch (it)
    ...
    case Nearest:
      {
      pinterp = new SourceAccessorNearestNeighborOf<DATA, DIMENSIONALITY, Real,
          SOURCE> ;
      break;
      }
    case Linear:
      {
      pinterp = new SourceAccessorLinearInterpolateOf<DATA, DIMENSIONALITY,
          Real, SOURCE> ;
      break;
      }
    case Cubic:
      {
      pinterp = new SourceAccessorCubicInterpolateOf<DATA, DIMENSIONALITY,
          Real, SOURCE> ;
      break;
      }
    default:
