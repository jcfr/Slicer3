...
class SourceCombinePointwiseOperatorBaseOf: public SourceCombineOf<DATA,
...
public:
  ...
  {
    return (_LINE + "SourceCombinePointwiseOperatorOf(" + DIMENSIONALITY + "D)"
        + LINE_ + this->DescribeCommon());
  }
...
class SourceCombinePointwiseOperatorOf: public SourceCombineOf<
    typename OPERATOR::type_data, DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceCombinePointwiseOperatorOf<OPERATOR, 2, PRECISION, SOURCE> : public SourceCombinePointwiseOperatorBaseOf<
    typename OPERATOR::type_data, 2, PRECISION, SOURCE>
{
...
//============================================================================
template<class OPERATOR, class PRECISION, class SOURCE>
class SourceCombinePointwiseOperatorOf<OPERATOR, 3, PRECISION, SOURCE> : public SourceCombinePointwiseOperatorBaseOf<
    typename OPERATOR::type_data, 3, PRECISION, SOURCE>
{
  typedef typename OPERATOR::type_data DATA;
public:
SOURCE_ACTUALS_3D  ;
...
{
public:
  typedef SourceCombinePointwiseOperatorOf<OperatorAverageOf<DATA,
      typename SOURCE::type_data> , DIMENSIONALITY, PRECISION, SOURCE> type;
};
...
{
public:
  typedef SourceCombinePointwiseOperatorOf<OperatorSumOf<DATA,
      typename SOURCE::type_data> , DIMENSIONALITY, PRECISION, SOURCE> type;
};
...
{
public:
  typedef SourceCombinePointwiseOperatorOf<OperatorDifferenceOf<DATA,
      typename SOURCE::type_data> , DIMENSIONALITY, PRECISION, SOURCE> type;
};
...
{
public:
  typedef SourceCombinePointwiseOperatorOf<OperatorIndexOfMaximumOf<DATA,
      typename SOURCE::type_data> , DIMENSIONALITY, PRECISION, SOURCE> type;
};
