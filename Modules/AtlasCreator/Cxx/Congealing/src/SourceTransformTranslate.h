...
class SourceTransformTranslateBaseOf: public SourceTransformOf<DATA,
...
public:
  SourceTransformTranslateBaseOf() :
    SourceTransformOf<DATA, DIMENSIONALITY, PRECISION, SOURCE> (), m_dpt(0.)
  {
  }

  virtual String Describe() const
  {
    return (_LINE + SerializationId() + LINE_ + (_INDENT + "translation by: "
        + m_dpt.Describe() + LINE_) + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceTransformTranslateOf: public SourceTransformTranslateBaseOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
...
class SourceTransformTranslateOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformTranslateBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformTranslateOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformTranslateBaseOf<
