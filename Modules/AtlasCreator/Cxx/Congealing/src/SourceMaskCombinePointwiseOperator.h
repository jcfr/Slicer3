...
// base class
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCEMASK,
    class SOURCECOMBINE>
class SourceMaskCombinePointwiseOperatorBaseOf: public SourceMaskCombineOf<
    DATA, DIMENSIONALITY, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
protected:
...
public:
  SourceMaskCombinePointwiseOperatorBaseOf() :
    SourceMaskCombineOf<DATA, DIMENSIONALITY, PRECISION, SOURCEMASK,
        SOURCECOMBINE> ()
  {
    m_vdata = NULL;
    m_cdata = 0;
  ...
  {
    return (_LINE + "SourceMaskCombinePointwiseOperatorOf(" + DIMENSIONALITY
        + "D)" + LINE_ + this->DescribeCommon());
  }

  virtual void PrepareForAccessAction() const
  {
    SourceMaskCombineOf<DATA, DIMENSIONALITY, PRECISION, SOURCEMASK,
        SOURCECOMBINE>::PrepareForAccessAction();
...
//============================================================================
//============================================================================
template<class OPERATOR, int DIMENSIONALITY, class PRECISION, class SOURCEMASK,
    class SOURCECOMBINE>
class SourceMaskCombinePointwiseOperatorOf: public SourceMaskCombineOf<
    TypeOfData(OPERATOR), DIMENSIONALITY, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
};
...
class SourceMaskCombinePointwiseOperatorOf<OPERATOR, 2, PRECISION, SOURCEMASK,
    SOURCECOMBINE> : public SourceMaskCombinePointwiseOperatorBaseOf<
    TypeOfData(OPERATOR), 2, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
...
//============================================================================
template<class OPERATOR, class PRECISION, class SOURCEMASK, class SOURCECOMBINE>
class SourceMaskCombinePointwiseOperatorOf<OPERATOR, 3, PRECISION, SOURCEMASK,
    SOURCECOMBINE> : public SourceMaskCombinePointwiseOperatorBaseOf<
    TypeOfData(OPERATOR), 3, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
typedef TypeOfData(OPERATOR) DATA;
public:
SOURCE_ACTUALS_3D  ;
...
public:
  ...
  static void FromSource(Pixel8BitGrey& dataOut, const Point256DReal& dataMask, const Pixel8BitGrey* vdata, const int& cdata)
  {
  ...
  static void ToSource(Point256DReal& dataMask, Pixel8BitGrey* vdata, const int& cdata, const Pixel8BitGrey& dataOut)
  {
...
public:
  typedef SourceMaskCombinePointwiseOperatorOf<
      typename OperatorWeightedAverageOf<TypeOfData(SOURCEMASK),
          TypeOfData(SOURCECOMBINE)>::type_data, DIMENSIONALITY, PRECISION,
      SOURCEMASK, SOURCECOMBINE> type;
};
