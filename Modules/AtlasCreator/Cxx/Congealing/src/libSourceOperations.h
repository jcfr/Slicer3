...
void CopyInto(SourceMemoryOf<DATA_OUT, DIMENSIONALITY>& srcOut, const SOURCE_IN &srcIn, bool bPrepared =
    false)
{
  if (!bPrepared)
    {
...
//============================================================================
template<class SOURCE_IN, int DIMENSIONALITY, class DATA_OUT>
void AllocatedCopy(SourceMemoryOf<DATA_OUT, DIMENSIONALITY>& srcOut, const SOURCE_IN& srcIn)
{
  srcIn.PrepareForAccess();
...
//============================================================================
template<class SOURCE_IN, int DIMENSIONALITY, class DATA_OUT>
void AllocatedCopy(SourceMemoryOf<DATA_OUT, DIMENSIONALITY>& srcOut, SOURCE_IN* psrcIn)
{
  ClaimPointer(psrcIn);
...
void CopyInto(SOURCE_OUT *psrcOut, SOURCE_IN *psrcIn, bool bPrepared = false)
{
  ClaimPointer(psrcIn);
