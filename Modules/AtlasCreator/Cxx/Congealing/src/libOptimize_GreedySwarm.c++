...
//============================================================================
bool OptimizeGreedySwarm(int cDimensions, double* vrParamMin, double* vrInitialScale, double fxnEval(double*, const void*), const void* pData, double rErrThreshold, int cIterations)
{
  ...
  for (int nIteration = 0; nIteration < cIterations; nIteration++)
    ...
    for (int nTestPoint = 0; nTestPoint < cTestPoints; nTestPoint++)
      ...
      for (int nDimension = 0; nDimension < cDimensions; nDimension++)
        ...
        vrParam[nDimension] = vrParamLast[nDimension] + rPoint
            * vrInitialScale[nDimension] * rScale;
        }
    ...
    D("Iteration %d/%d MinError %2.5f SCALE %2.5f", nIteration, cIterations,
        rErrMin, rScale);
...
//============================================================================
bool OptimizeGreedySwarmX(int cDimensions, double* vrParamMin, double* vrInitialScale, double fxnEval(double*, const void*), const void* pData, double rErrThreshold, int cIterations)
{
  ...
  for (int nIteration = 0; nIteration < cIterations; nIteration++)
    ...
    while (1)
      ...
      if (rErr < rErrMin)
        {
        D("Iteration %d/%d MinError %2.5f SCALE %2.5f", nIteration,
            cIterations, rErrMin, rScale);
        if (rErr < .95 * rErrMin)
          {
          nIteration = 0;
          }
...
//============================================================================
//============================================================================
bool OptimizeGreedySwarm2(int cDimensions, double* vr0, double* vrInitialScale, double fxnEval(double*, const void*), const void* pData, double rErrThreshold, int cIterations)
{
...
//============================================================================
//============================================================================
bool OptimizeGreedySwarm3(int cDimensions, double* vrMin, double* vrInitialScale, double fxnEval(double*, const void*), const void* pData, double rErrThreshold, int cIterations)
{
  ...
  for (int nIteration = 0; nIteration < cIterations; nIteration++)
    ...
    for (int nDimension = 0; nDimension < cDimensions; nDimension++)
      {
      double rPoint = double(rand() % 2000000) / 1000000 - 1.0;
      vr1[nDimension] = vr0[nDimension] + rPoint * vrInitialScale[nDimension]
          * rScale;
      }
