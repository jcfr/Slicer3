...
class ImageOf: public SourceMemoryOf<DATA, DIMENSIONALITY>
{
public:
...
template<class DATA>
class ImageOf<DATA, 2> : public SourceMemoryOf<DATA, 2>
{
  typedef int PRECISION;
public:
  virtual String Describe() const
  {
    return (_LINE + "Image2D" + LINE_ + this->DescribeCommon());
  }
...
template<class DATA>
class ImageOf<DATA, 3> : public SourceMemoryOf<DATA, 3>
{
  typedef int PRECISION;
public:
  ImageOf() :
  ...
  virtual String Describe() const
  {
    return (_LINE + "Image3D" + LINE_ + this->DescribeCommon());
  }
