...
ImageOf<DATA, DIMENSIONALITY> DownsampleAlong(const PointOf<DIMENSIONALITY,
    PRECISION> &ptDimension, const SourceOf<DATA, DIMENSIONALITY, PRECISION>& iIn)
{
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION>
ImageOf<DATA, DIMENSIONALITY> Downsample(int cTimes, const SourceOf<DATA,
    DIMENSIONALITY, PRECISION>& srcIn,
)
  {
  if (cTimes==0)
    {
...
ImageOf<DATA, 2> Downsample(const SourceOf<DATA, 2, PRECISION>& src)
{
...
//============================================================================
template<class DATA, class PRECISION>
ImageOf<DATA, 3> Downsample(const SourceOf<DATA, 3, PRECISION>& src)
{
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION>
ImageOf<DATA, DIMENSIONALITY> Downsample(int cTimes, SourceOf<DATA,
    DIMENSIONALITY, PRECISION>* psrcIn)
{
  ClaimPointer(psrcIn);
  if (cTimes == 0)
    {
