...
class SourceAccessorEdgePadOf: public SourceAccessorOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
public:
};
...
class SourceAccessorEdgePadOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorOf<
...
public:
  SourceAccessorEdgePadOf() :
    SourceAccessorOf<DATA, 2, PRECISION, SOURCE> (), m_dataPad(0)
  {
  }

  virtual void Describe() const
  {
    return (_LINE + "SourceAccessorEdgePadOf(2D)" + LINE_
        + this->DescribeCommon());
  }
