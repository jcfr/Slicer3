...
class SourceTransformScaleBaseOf: public SourceTransformOf<DATA,
...
public:
  ...
  {
    return (_LINE + SerializationId() + LINE_ + (_INDENT + "scale factors: "
        + m_ptScale.Describe() + LINE_) + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceTransformScaleOf: public SourceTransformScaleBaseOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceTransformScaleOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformScaleBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformScaleOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformScaleBaseOf<
