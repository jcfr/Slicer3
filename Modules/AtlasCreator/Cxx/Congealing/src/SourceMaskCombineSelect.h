...
class SourceMaskCombineSelectOf: public SourceMaskCombineOf<DATA,
...
class SourceMaskCombineSelectOf<DATA, 2, PRECISION, SOURCEMASK, SOURCECOMBINE> : public SourceMaskCombineOf<
    DATA, 2, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
public:
  virtual String Describe() const
  {
    return (_LINE + "SourceMaskCombineSelectOf(" + DIMENSIONALITY + "D)"
...
//============================================================================
template<class DATA, class PRECISION, class SOURCEMASK, class SOURCECOMBINE>
class SourceMaskCombineSelectOf<DATA, 3, PRECISION, SOURCEMASK, SOURCECOMBINE> : public SourceMaskCombineOf<
    TypeOfData(DATA), 3, PRECISION, SOURCEMASK, SOURCECOMBINE>
{
