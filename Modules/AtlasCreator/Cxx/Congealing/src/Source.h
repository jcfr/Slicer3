...
class SourceBaseOf: public BasicSource
{
...
public:
  ...
  {
    return _INDENT + (_LINE + "size: " + this->Size().Describe() + LINE_);
  }
...
template<class DATA, int DIMENSIONALITY, class PRECISION>
class SourceOf: public SourceBaseOf<DATA, DIMENSIONALITY, PRECISION>
{
};

template<class DATA, class PRECISION>
class SourceOf<DATA, 2, PRECISION> : public SourceBaseOf<DATA, 2, PRECISION>
{
...
public:
  ...
  virtual void
      VirtualGet(DATA& dataOut, const PRECISION& nX, const PRECISION& nY) const =0;
  virtual void
      VirtualSet(const PRECISION& nX, const PRECISION& nY, const DATA& data)=0;
};

template<class DATA, class PRECISION>
class SourceOf<DATA, 3, PRECISION> : public SourceBaseOf<DATA, 3, PRECISION>
{
...
public:
  ...
  virtual void
      VirtualGet(DATA& dataOut, const PRECISION& nX, const PRECISION& nY, const PRECISION& nZ) const =0;
  virtual void
      VirtualSet(const PRECISION& nX, const PRECISION& nY, const PRECISION& nZ, const DATA& data)=0;

};

template<class SOURCE, class DATA, int DIMENSIONALITY, class PRECISION>
inline void GetPoint(const SOURCE& src, DATA& dataOut, const PointOf<
    DIMENSIONALITY, PRECISION>& pt)
{
  src.GetPoint(dataOut, pt);
}

template<class DATA, int DIMENSIONALITY, class PRECISION, class PRECISION2>
inline void GetPoint(const SourceOf<DATA, DIMENSIONALITY, PRECISION>& src, DATA& dataOut, const PointOf<
    DIMENSIONALITY, PRECISION2>& pt)
{
  src.VirtualGetPoint(dataOut, pt);
}

template<class SOURCE, class DATA, int DIMENSIONALITY, class PRECISION>
inline void SetPoint(SOURCE& src, const PointOf<DIMENSIONALITY, PRECISION>& pt, const DATA& data)
{
  src.SetPoint(pt, data);
}

template<class DATA, int DIMENSIONALITY, class PRECISION, class PRECISION2>
inline void SetPoint(SourceOf<DATA, DIMENSIONALITY, PRECISION>& src, const PointOf<
    DIMENSIONALITY, PRECISION2>& pt, const DATA& data)
{
...
inline void Get(const SOURCE& src, DATA& dataOut, const PRECISION& nX, const PRECISION& nY)
{
  src.Get(dataOut, nX, nY);
}
template<class DATA, class PRECISION, class PRECISION2>
inline void Get(const SourceOf<DATA, 2, PRECISION>& src, DATA& dataOut, const PRECISION2& nX, const PRECISION2& nY)
{
  src.VirtualGet(dataOut, src.cast_precision(nX), src.cast_precision(nY));
}

template<class SOURCE, class DATA, class PRECISION>
inline void Set(SOURCE& src, const PRECISION& nX, const PRECISION& nY, const DATA& data)
{
  src.Set(nX, nY, data);
}

template<class DATA, class PRECISION, class PRECISION2>
inline void Set(SourceOf<DATA, 2, PRECISION>& src, const PRECISION2& nX, const PRECISION2& nY, const DATA& data)
{
...
template<class SOURCE, class DATA, class PRECISION>
inline void Get(const SOURCE& src, DATA& dataOut, const PRECISION& nX, const PRECISION& nY, const PRECISION& nZ)
{
  src.Get(dataOut, nX, nY, nZ);
}

template<class DATA, class PRECISION, class PRECISION2>
inline void Get(const SourceOf<DATA, 3, PRECISION>& src, DATA& dataOut, const PRECISION2& nX, const PRECISION2& nY, const PRECISION2& nZ)
{
  src.VirtualGet(dataOut, src.cast_precision(nX), src.cast_precision(nY),
      src.cast_precision(nZ));
}

template<class SOURCE, class DATA, class PRECISION>
inline void Set(SOURCE& src, const PRECISION& nX, const PRECISION& nY, const PRECISION& nZ, const DATA& data)
{
  src.Set(nX, nY, nZ, data);
}

template<class DATA, class PRECISION, class PRECISION2>
inline void Set(SourceOf<DATA, 3, PRECISION>& src, const PRECISION2& nX, const PRECISION2& nY, const PRECISION2& nZ, const DATA& data)
{
  src.VirtualSet(src.cast_precision(nX), src.cast_precision(nY),
      src.cast_precision(nZ), data);
}
