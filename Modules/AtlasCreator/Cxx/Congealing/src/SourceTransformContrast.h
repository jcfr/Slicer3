...
class SourceTransformContrastOf: public SourceTransformOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
...
class SourceTransformContrastOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformContrastOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformOf<
