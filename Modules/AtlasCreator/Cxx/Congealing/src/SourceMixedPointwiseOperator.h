...
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE1,
    class SOURCE2>
class SourceMixedPointwiseOperatorBaseOf: public SourceMixedOf<DATA,
...
public:
  ...
  {
    return (_LINE + "SourceMixedPointwiseOperatorOf(" + DIMENSIONALITY + "D)"
...
//============================================================================
//============================================================================
template<class OPERATOR, int DIMENSIONALITY, class PRECISION, class SOURCE1,
    class SOURCE2>
class SourceMixedPointwiseOperatorOf: public SourceMixedOf<
    typename OPERATOR::type_data, DIMENSIONALITY, PRECISION, SOURCE1, SOURCE2>
{
};
...
class SourceMixedPointwiseOperatorOf<OPERATOR, 2, PRECISION, SOURCE1, SOURCE2> : public SourceMixedPointwiseOperatorBaseOf<
    typename OPERATOR::type_data, 2, PRECISION, SOURCE1, SOURCE2>
{
...
class SourceMixedPointwiseOperatorOf<OPERATOR, 3, PRECISION, SOURCE> : public SourceMixedPointwiseOperatorBaseOf<
...
{
public:
  typedef SourceMixedPointwiseOperatorOf<OperatorLookupDimensionOf<
      TypeOfData(SOURCE1), TyoeOfData(SOURCE2)>::type, DIMENSIONALITY,
      PRECISION, SOURCE1, SOURCE2> type;
};
