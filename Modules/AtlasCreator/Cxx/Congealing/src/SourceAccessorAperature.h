...
class SourceAccessorAperatureBaseOf: public SourceAccessorOf<DATA,
...
public:
  SourceAccessorAperatureBaseOf() :
    SourceAccessorOf<DATA, DIMENSIONALITY, PRECISION, SOURCE> (),
        m_ptAperatureOffset(0), m_ptAperatureSize(0)
  {
  }

  void SetAperature(const PointOf<DIMENSIONALITY, PRECISION>& ptAperatureOffset, const PointOf<
      DIMENSIONALITY, PRECISION>& ptAperatureSize)
  {
  ...
  {
    return (_LINE + SerializationId() + LINE_ + (_INDENT + "with offset:"
        + m_ptAperatureOffset.Describe() + LINE_) + (_INDENT + "and  size:"
        + m_ptAperatureSize.Describe() + LINE_) + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceAccessorAperatureOf: public SourceAccessorAperatureBaseOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceAccessorAperatureOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorAperatureBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorAperatureOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorAperatureBaseOf<
