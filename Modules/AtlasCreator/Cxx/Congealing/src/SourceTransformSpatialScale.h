...
class SourceTransformSpatialScaleBaseOf: public SourceTransformOf<DATA,
...
public:
  SourceTransformSpatialScaleBaseOf() :
    SourceTransformOf<DATA, DIMENSIONALITY, PRECISION, SOURCE> (), m_pcoefs(
        NULL)
  {
  }
  ...
  {
    return (_LINE + "SourceTransformSpatialScale" + LINE_ + (_INDENT
        + "with coeffients: " + LINE_) + (_INDENT2 + m_pcoefs->Describe())
        + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceTransformSpatialScaleOf: public SourceTransformSpatialScaleBaseOf<
    DATA, DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceTransformSpatialScaleOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformSpatialScaleBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformSpatialScaleOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformSpatialScaleBaseOf<
...
SourceMemoryOf<Real, DIMENSIONALITY>* CoefficientTable(const PointOf<
    DIMENSIONALITY, int> &ptSize, ...)
{
  SourceMemoryOf < Real, DIMENSIONALITY > *pi = new SourceMemoryOf<Real,
      DIMENSIONALITY> ();
  pi->Allocate(ptSize);
