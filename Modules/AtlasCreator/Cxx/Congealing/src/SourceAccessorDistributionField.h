...
public:
  ...
  static void ComputeDistributionFieldParzen(Point256DReal* vdata, const Real& rSigmaParzen)
  {
    ...
    if (rSigmaParzenLast != rSigmaParzen)
      ...
      //--------------------------------------------------------
      D(
          "precomputing Parzen 'explosion' for each possible value with sigma %g",
          rSigmaParzen);
      for (int n = 0; n < 256; n++)
        {
...
class SourceAccessorDistributionFieldBaseOf: public SourceAccessorOf<DATA,
...
public:
  ...
  {
    return (_LINE + SerializationId() + LINE_ + (_INDENT
        + "with parzen sigma of: " + m_rSigmaParzen + LINE_)
        + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceAccessorDistributionFieldOf: public SourceAccessorOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceAccessorDistributionFieldOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorDistributionFieldBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorDistributionFieldOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorDistributionFieldBaseOf<
