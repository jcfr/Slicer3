...
class SourceCombineLayoutBaseOf: public SourceCombineOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceCombineLayoutOf: public SourceCombineOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
};
...
class SourceCombineLayoutOf<DATA, 2, PRECISION, SOURCE> : public SourceCombineLayoutBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceCombineLayoutOf<DATA, 3, PRECISION, SOURCE> : public SourceCombineLayoutBaseOf<
...
{
public:
  typedef SourceCombineLayoutOf<DATA, DIMENSIONALITY, PRECISION, SourceOf<DATA,
      DIMENSIONALITY, PRECISION> > type;
};
