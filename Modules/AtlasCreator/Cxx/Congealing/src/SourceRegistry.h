...
typedef SourceAccessorSliceOf<Pixel12BitGrey, 2, int, Source_S3I>
    Source_S2I_Slice_S3I;
typedef SourceAccessorSliceOf<Pixel8BitGrey, 2, int, Source_G3I>
    Source_G2I_Slice_G3I;
typedef SourceAccessorSliceOf<Pixel8BitGrey, 2, Real, Source_G3R>
    Source_G2R_Slice_G3R;
typedef SourceAccessorSliceOf<Pixel8BitGrey, 2, int, Source_G3R>
    Source_G2I_Slice_G3R;
