...
class SourceAccessorRangeScaleBaseOf: public SourceAccessorOf<DATA,
...
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceAccessorRangeScaleOf: public SourceAccessorRangeScaleBaseOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};

template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorRangeScaleOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorRangeScaleBaseOf<
...
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorRangeScaleOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorRangeScaleBaseOf<
