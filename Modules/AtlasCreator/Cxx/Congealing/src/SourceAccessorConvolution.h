...
class SourceAccessorConvolutionBaseOf: public SourceAccessorOf<DATA,
...
public:
  SourceAccessorConvolutionBaseOf() :
    SourceAccessorOf<DATA, DIMENSIONALITY, PRECISION, SOURCE> (), m_psrcFilter(
        NULL)
  {
  }
  ...
  {
    return (_LINE + SerializationId() + LINE_ + (_INDENT + "with filter:"
        + LINE_) + (_INDENT
        + (_INDENT + this->m_psrcFilter->Describe() + LINE_))
        + this->DescribeCommon());
  }
...
//============================================================================
template<class DATA, int DIMENSIONALITY, class PRECISION, class SOURCE>
class SourceAccessorConvolutionOf: public SourceAccessorOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};
...
class SourceAccessorConvolutionOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorConvolutionBaseOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorConvolutionOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorConvolutionBaseOf<
