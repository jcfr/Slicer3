...
class SourceTransformRemapOf: public SourceTransformOf<DATA, DIMENSIONALITY,
    PRECISION, SOURCE>
{
...
class SourceTransformRemapOf<DATA, 2, PRECISION, SOURCE> : public SourceTransformOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceTransformRemapOf<DATA, 3, PRECISION, SOURCE> : public SourceTransformOf<
