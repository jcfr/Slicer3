...
inline typename PromotionOf<PRECISION, Real>::type Gaussian(const PRECISION& rWhere, const PRECISION& rMean, const PRECISION& rSigma)
{
...
GaussianCurve(const PointOf<DIMENSIONALITY, Real>& ptrSigma, const PointOf<
    DIMENSIONALITY, int>& ptSupport)
{
