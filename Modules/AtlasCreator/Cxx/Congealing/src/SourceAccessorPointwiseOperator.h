...
class SourceAccessorPointwiseOperatorBaseOf: public SourceAccessorOf<DATA,
...
public:
  ...
  {
    return (_LINE + "SourceAccessorPointwiseOperatorOf(" + DIMENSIONALITY
...
class SourceAccessorPointwiseOperatorOf: public SourceAccessorOf<
...
class SourceAccessorPointwiseOperatorOf<OPERATOR, 2, PRECISION, SOURCE> : public SourceAccessorPointwiseOperatorBaseOf<
...
//============================================================================
template<class OPERATOR, class PRECISION, class SOURCE>
class SourceAccessorPointwiseOperatorOf<OPERATOR, 3, PRECISION, SOURCE> : public SourceAccessorPointwiseOperatorBaseOf<
