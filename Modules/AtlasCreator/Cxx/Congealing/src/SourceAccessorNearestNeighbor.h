...
class SourceAccessorNearestNeighborOf: public SourceAccessorOf<DATA,
    DIMENSIONALITY, PRECISION, SOURCE>
{
};

template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorNearestNeighborOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorOf<
...
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorNearestNeighborOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorOf<
