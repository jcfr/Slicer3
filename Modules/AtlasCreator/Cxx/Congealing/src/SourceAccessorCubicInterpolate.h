...
class SourceAccessorCubicInterpolateOf: public SourceAccessorOf<DATA,
...
class SourceAccessorCubicInterpolateOf<DATA, 2, PRECISION, SOURCE> : public SourceAccessorOf<
...
//============================================================================
template<class DATA, class PRECISION, class SOURCE>
class SourceAccessorCubicInterpolateOf<DATA, 3, PRECISION, SOURCE> : public SourceAccessorOf<
