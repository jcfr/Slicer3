...
public:
  ...
  template<int DIMENSIONALITY2, class PRECISION2>
  PointOf<DIMENSIONALITY, PRECISION>& operator=(const PointOf<DIMENSIONALITY2,
      PRECISION2> &pt)
  {
    int c = min(DIMENSIONALITY, DIMENSIONALITY2);
    for (int n = 0; n < c; n++)
  ...
  PointOf<DIMENSIONALITY, PRECISION>& AdvanceLoop(const PointOf<DIMENSIONALITY,
      PRECISION>& ptBy = 1)
  {
    m_vx[0] += ptBy.m_vx[0];
    return *this;
  ...
  bool StillLooping(const PointOf<DIMENSIONALITY, PRECISION>& ptTo = 0, const PointOf<
      DIMENSIONALITY, PRECISION>& ptFrom = 0, const PointOf<DIMENSIONALITY,
      PRECISION>& ptBy = 1)
  {
  ...
  PointOf<DIMENSIONALITY, PRECISION> Bound(const PointOf<2, PRECISION> &ptMin, const PointOf<
      2, PRECISION> &ptMax) const
  {
...
inline PointOf<DIMENSIONALITY, PRECISION> NewRandomPoint(const PointOf<
...
typename PromotionOf<PointOf<DIMENSIONALITY, T1> , PointOf<DIMENSIONALITY, T2> >::type Modulo(PointOf<
    DIMENSIONALITY, T1> t, PointOf<DIMENSIONALITY, T2> tBase)
{
