...
namespace eval EMSegmenterPreProcessingTcl {
    ...
    proc ShowUserInterface { } {
        ...
        if { [InitVariables] } {
            puts stderr "ERROR: Lesion Exp: ShowUserInterface: Not all variables are correctly defined!"
            return 1
        }
        $LOGIC PrintText  "TCLMRI: Preprocessing Lesion Exp - ShowUserInterface"
