...
int main( int argc , char * argv[] )
{
  ...
  */
  ...
  if (!dynamic_cast<BSplineDeformableTransformType::BulkTransformType* > ( transformFile->GetTransformList()->front().GetPointer()))
  {
  ...
  BSplineDeformableTransformType::BulkTransformType* bulkTfm =
    dynamic_cast<BSplineDeformableTransformType::BulkTransformType*> (transformFile->GetTransformList()->front().GetPointer());
  ...
  DeformationFieldType::Pointer deformationField = DeformationFieldType::New(); //Filter L's kernnel form tile to same size as the input image
